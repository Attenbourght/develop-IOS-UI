...
class ProfileHeaderView: UIView {
    ...
    lazy var userAvatarImage: UIImageView = {
        ...
        userAvatarImage.image = UIImage(named: "Zealot")
    ...
    lazy var userStatusTextField: UITextField = {
        ...
        userStatusTextField.text = "Ожидание"
    ...
    lazy var showStatusButton: UIButton = {
        ...
        showStatusButton.setTitle("Изменить статус", for: .normal)
    ...
    lazy var newStatusTextField: UITextField = {
        ...
        newStatusTextField.text = "Введите новый статус"
